...
* **Verifica y valida** el simulador:
  ...
  * Utiliza las efemérides `2028-12-31_00-00-00.csv` como estado inicial del sistema solar. Luego selecciona un tiem step y valida tus resultados contra las efemérides de referencia `2029-08-28_00_00_00.csv`. Realiza tu comparación en el módulo `physics/mission`.
...
* Las efemérides fueron generadas con [Skyfield](https://rhodesmill.org/skyfield/), [DE441](https://ssd.jpl.nasa.gov/doc/de440_de441.html) y [MPCORB](https://www.minorplanetcenter.net/iau/MPCORB.html).
